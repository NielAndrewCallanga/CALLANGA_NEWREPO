...
#3 A factory has a census of its workers. There are 50 workers in total. The following list  shows their ages:
  ...
  #3.c	Access all but the 1st element is not included. Write the R code and its output.
    workers_age[2:50]
    #Output:
    #[1] 28 22 36 27 18 52 39 42 29 35 31 27 22 37 34 19 20 57 49 50 37 46 25 17 37 43 53 41 	51 35 	24 33
...
#8.	The table below gives the 25 most powerful celebrities and their annual pay as ranked by the editions of Forbes magazine and as listed on the Forbes.com website.
  ...
  #Output
  #67  90 225 110  90 332 302  41  52  88  55  44  55  40 233  34  40  47  90  25  39  45  32  40
  #31
