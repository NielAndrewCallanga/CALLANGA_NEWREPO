...
library("readxl")
  data <- read_excel("D:/CS101_BSIT1A/CALLANGA_NEWREPO/Worksheet7a/Breast_Cancer.xlsx")
...
```{r , include=TRUE}
  ...
  library(xlsx)
  write.xlsx("abalone", "D:\\CS101_BSIT1A\\CALLANGA_NEWREPO\\Worksheet7a\\abalone.xlsx")
```
